...
import product from "../../assets/images/product/product8.jpg";
          ...
          <div className="flex flex-col md:flex-row gap-5 lg:gap-16">
            ...
            <div className="md:w-[50%] lg:py-5">
              <div>
                ...
                <div className="my-5 lg:my-10 w-[90%] font-medium text-gray-700 text-sm lg:text-base">
                  <p>
                    Lorem ipsum dolor sit amet consectetur, adipisicing elit.
                    Iusto, natus.
                  </p>
                  <p className="mt-3 lg:mt-5 text-justify">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit.
