    ...
    <Container>
      <div className="flex flex-col lg:flex-row justify-between items-center gap-4 lg:gap-10">
        ...
        <div className="lg:w-[40%]">
          <div>
            <h1 className="text-4xl md:text-5xl lg:text-6xl leading-14 md:leading-16 lg:leading-20">Find your perfect look at Laivaly new on <span className="font-semibold text-[#31473A] text-5xl md:text-6xl lg:text-7xl">Singapore</span></h1>
          </div>
          ...
          <div className="space-y-3 lg:space-y-5">
            ...
            <button className="border-2 border-[#31473A] hover:bg-[#31473A] hover:text-white duration-1000 cursor-pointer px-5 py-2 rounded-full text-balance lg:text-lg font-semibold">See on Map</button>
          </div>
        </div>
      </div>
    </Container>
