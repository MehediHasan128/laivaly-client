    ...
    <div className="bg-[#EDF4F2]">
      <Container>
        <div className="flex justify-between items-center pt-36">
          <div className="flex-grow space-y-3 pl-42">
            {/* Main title */}
            <div className="space-y-3">
              ...
              <p className="text-xl text-gray-600">
                Discover trendsetting fashion made for confidence, comfort, and
                culture. <br /> From streetwear to elegant fits — Laivaly
            ...
            {/* Shop Now button */}
            <button className="bg-[#31473A] px-6 py-4 rounded-full text-white font-semibold flex items-center gap-2 hover:translate-x-2 duration-700 cursor-pointer">
