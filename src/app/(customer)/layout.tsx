            ...
            <div className="md:w-[60%] lg:w-[50%]">
              ...
              <div className="md:w-[80%] mt-10 md:mt-20 font-medium">
                <p className="text-sm text-gray-700 text-justify">
                  Please contact Customer Service if you have questions about
                  your account, or if you are not seeing transactions that
                  should have been posted.
                </p>

                <div>
                  <h1 className="text-lg md:text-xl font-semibold my-3 md:my-5">
                    Need Help?
                  </h1>
                  <div className="text-gray-700 text-sm space-y-3 md:space-y-5">
                    <button className="hover:underline duration-500 cursor-pointer block">
